...
import FlightPointsDashboard from "./FlightPointsDashboard";
...
const renderDashboard = async (squadron = SQUADRONS.FAKETON) => {
  const result = renderWithProviders(<FlightPointsDashboard user={userFor(squadron)} />, { squadron });
...
describe("more than two competing flights", () => {
  ...
  const renderWithFourFlights = async () => {
    const result = renderWithProviders(<FlightPointsDashboard />, {
